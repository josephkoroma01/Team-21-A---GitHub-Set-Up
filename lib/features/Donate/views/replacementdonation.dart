...
import 'package:lifebloodworld/features/Home/views/home.dart';
...
class ReplacementDonation extends StatefulWidget {
  ReplacementDonation({
    Key? key,
    required this.title,
  }) : super(key: key);
  ...
  _ReplacementDonationState createState() => _ReplacementDonationState();
}

class _ReplacementDonationState extends State<ReplacementDonation> {
  ...
  final List<String> patientrelationItems = [
    'Mother',
    'Father',
    'Sister',
    'Brother',
  ...
  Future register() async {
    ...
    if (data == "Error") {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Center(
          child: Text('Family Replacement Schedule Successfully',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          elevation: 0,
          title: Text(
            'Schedule Replacement Blood Donation',
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Family Replacement Donation',
