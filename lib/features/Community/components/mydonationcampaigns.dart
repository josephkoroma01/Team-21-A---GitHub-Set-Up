  ...
  Future<List<DonationCampaigndata>> getMyCampaigns(String query) async {
    ...
    if (response.statusCode == 200) {
      ...
      return campaign
        ...
        final targeteddistrictLower =
            campaign.campaigndescription.toLowerCase();
                                                                                                                    ...
                                                                                                                    onPressed: () async {
                                                                                                                      if (await getInternetUsingInternetConnectivity()) {
                                                                                                                        ...
                                                                                                                        await Navigator.push(
                                                                                                                          context,
                                                                                                                          MaterialPageRoute(
                                                                                                                            builder: (context) => myDonationCampaigns(),
                                                                                                                          ),
                                                                                                                        );
// scheduleAlarm()
                                                                                                                      } else {
...
class registeredDonors extends StatefulWidget {
  ...
  State<registeredDonors> createState() =>
      _registeredDonorsState(campaignname: campaignname);
}
...
class _registeredDonorsState extends State<registeredDonors> {
  ...
  Future<List<RegisteredDonordata>> getBloodDonor(String donorregquery) async {
    ...
    var response = await http.post(
        Uri.parse(
            "http://nsbslifeblood.niche.sl/findregisteredcampaigndonors.php"),
        body: json.encode(data));
