...
class CommunityBodyState extends State<CommunityBody> {
  ...
  Future joinbloodcommunity() async {
    ...
    var response = await http
        .post(Uri.parse("http://lifebloodsl.com/communityapi/joincommunity.php"), body: {
      "firstname": ufname,
      "middlename": umname,
      "lastname": ulname,
      "gender": gender,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              "LifeBlood",
              style: GoogleFonts.montserrat(fontSize: 32.sp, fontWeight: FontWeight.bold, color: Color(0xFF205072)),
            ),
            SizedBox(height: 2.h),
            Text(
              "Give Blood. Save Lives",
              style: GoogleFonts.montserrat(fontSize: 14.sp, fontWeight: FontWeight.w500, color: Color(0xFF68B2A0)),
            ),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image.asset('assets/icons/community.png', height: 40.h, width: 40.w,),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Blood\nCommunities', textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 14.sp, color: Color(0xff406986))),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Find Blood Community',
                              ...
                              textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 11.sp, color: Colors.grey)),
SizedBox(
  height: 5.h,
),
                          (community == 'Joined') ?  Container(
                            width: double.infinity,
                            child:  TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>BloodCommunity(),),);
    ...
    child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image.asset('assets/icons/blog.png', height: 40.h, width: 40.h,),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Health \nBlog Tips', textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 14.sp, color: Color(0xff406986))),
                          SizedBox(
                            height: 5.h,
                          ),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image.asset('assets/icons/megaphone.png', height: 40.h, width: 40.h,),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Donation Campaigns', textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 14.sp, color: Color(0xff406986))),
                          SizedBox(
                            height: 5.h,
                          ),
                          ...
                          Container(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => DonationCampaigns()));
                              },
                            ),
                          )
                        ],
    ...
    child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image.asset('assets/icons/coins.png', height: 40.h, width: 40.w,),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Support \nLifeBlood', textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 14.sp, color: Color(0xff406986))),
                          SizedBox(
                            height: 5.h,
                          ),
                          Text('Support Blood Banks',
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 11.sp, color: Colors.grey)),
                          SizedBox(
                            height: 5.h,
                          ),
                          Container(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => SupportLifeBloodScreen()));
                              },
                            ),
                          )
                        ],
