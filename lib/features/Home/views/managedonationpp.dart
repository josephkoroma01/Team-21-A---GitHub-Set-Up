...
class _managedonationAppointmentsState
  ...
  Future<List<Schedule>> getBloodDonationApp(String donationquery) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: FutureBuilder<List<Schedule>>(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  ...
                                                                                  InkWell(
                                                                                    onTap: () async {
                                                                                      await Clipboard.setData(ClipboardData(text: data.refcode.toString()));
                                                                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                                                                        duration: Duration(seconds: 5),
